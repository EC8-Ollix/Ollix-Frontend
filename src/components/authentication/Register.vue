...
export default defineComponent({
    ...
    setup() {
        ...
        const validatePassword = (rule: Rule, value: string) => {
            ...
            } else if (value !== userState.confirmPassword) {
    ...
    <div class="register-container">
        ...
        <div class="register-form">
            ...
            >
                ...
                <a-form-item label="Confirme a Senha" name="confirmPassword">
                    <a-input-password
            ...
            <p>
                ...
                <router-link to="/Ollix-Frontend/login">
                    <a-button size="small" type="link"> Entre aqui</a-button>
                </router-link>
            </p>
